      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-soft hover:shadow-medium transition-shadow duration-300 border border-gray-100">
                <div className="text-4xl md:text-5xl font-bold text-primary-600 mb-2 font-display group-hover:scale-110 transition-transform duration-200">
                  {stat.number}
                </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Comprehensive preprocessing ensures clean, reliable data for analysis</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Get instant soil analysis and recommendations powered by ML</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Promote eco-friendly agriculture through optimized resource usage</p>
          </div>
        </div>
      </div>
    </section>
