    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-green-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">FertiSmart</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-block px-4 py-2 bg-gradient-to-r from-green-100 to-blue-100 rounded-full mb-4">
            <span className="text-sm font-semibold text-green-700">Random Forest ML Algorithm</span>
          </div>
          ...
          <Card className="shadow-2xl border-t-4 border-green-500">
            ...
            <CardContent className="pt-6">
              <form onSubmit={handlePredict} className="space-y-6">
                {/* Soil Nutrients */}
                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border-2 border-green-100">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border-2 border-blue-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">🌤️ Climate Conditions</h3>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">🌧️ Soil pH & Rainfall</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 hover:from-green-700 hover:via-blue-700 hover:to-purple-700 text-white font-bold py-4 text-lg"
                >
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-3">
                      {predictionResult.top_recommendations.map((rec, index) => (
                        <div key={index} className={`p-4 rounded-lg border-2 ${index === 0 ? 'bg-green-50 border-green-300' : 'bg-gray-50 border-gray-200'}`}>
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-lg font-semibold">#{index + 1} {rec.crop}</span>
                            <span className="text-xl font-bold text-blue-600">{rec.confidence}%</span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div className="bg-gradient-to-r from-blue-500 to-green-500 h-2 rounded-full" style={{ width: `${rec.confidence}%` }}></div>
                          </div>
                        </div>
                      ))}
                    </div>
